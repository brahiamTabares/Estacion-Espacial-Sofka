...
public class Lanzadera extends Nave implements Serializable{
   ...
   private double capacidadTransporte;
    ...
    @Builder
    public Lanzadera(String idNave, String nombre, String tipoNave, String tipoCombustible, double peso, double capacidadEmpuje, double orbitacion, double altura, int numeroMotores, double capacidadTransporte, String tipoTransporte) {
